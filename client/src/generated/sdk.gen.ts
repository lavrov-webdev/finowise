...
export const transactionsControllerFindAll = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<TransactionsControllerFindAllResponse, TransactionsControllerFindAllError, ThrowOnError>({
        ...options,
        url: '/transactions'
    });
};

export const transactionsControllerFindBySprint = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<TransactionsControllerFindBySprintData, ThrowOnError>) => {
    return (options?.client ?? client).get<TransactionsControllerFindBySprintResponse, TransactionsControllerFindBySprintError, ThrowOnError>({
        ...options,
        url: '/transactions/by_sprint/{sprintId}'
    });
};
