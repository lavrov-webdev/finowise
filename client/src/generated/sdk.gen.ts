...
export const reportControllerFind = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<ReportControllerFindData, ThrowOnError>) => {
    return (options?.client ?? client).get<ReportControllerFindResponse, ReportControllerFindError, ThrowOnError>({
        ...options,
        url: '/report'
    });
};