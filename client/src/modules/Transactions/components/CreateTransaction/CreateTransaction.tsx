import { getTransactionsBySprintQueryOptions, getTransactionsQueryOptions } from "@modules/Transactions/api/queryOptions";
...
export const CreateTransaction = () => {
  ...
  const transactionsState = useQuery(getTransactionsBySprintQueryOptions(currentSprintQuery.data?.data?.id));
